      ...
      return (
        <div className="mt-16 md:mt-0 md:ml-80 bg-white h-full w-full md:w-3/4">
          ...
          <div className="m-8 bg-slate-300 pl-4 pr-2 md:py-2  bordere border-black pt-11 border rounded-md">
            <div className="font-bold text-lg"> Welcome To <span className="text-red-500">WATCHLIST</span></div>
          ...
          <div className="flex justify-center items-center my-8">
            <input className="px-5 w-5/6 border border-gray-400 p-2 rounded-l" type="text" value={searchText} onChange={(e) => setSearchText(e.target.value)} onKeyDown={handleKeyDown} />
            <button className="border border-gray-400 px-5 py-2 rounded-r bg-gray-100" onClick={handleClick}>🔍</button>
          </div>
          {/* MovieContainer */}
